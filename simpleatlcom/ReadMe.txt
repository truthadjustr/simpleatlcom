========================================================================
    ACTIVE TEMPLATE LIBRARY : simpleatlcom Project Overview
========================================================================

AppWizard has created this simpleatlcom project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

simpleatlcom.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

simpleatlcom.vcxproj.filters
...
simpleatlcom.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (simpleatlcom.h)
        GUID definitions                                (simpleatlcom_i.c)
        A type library                                  (simpleatlcom.tlb)
        Marshaling code                                 (simpleatlcom_p.c and dlldata.c)

simpleatlcom.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in simpleatlcom.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named simpleatlcom.pch and a precompiled types file named StdAfx.obj.
...
simpleatlcomps.vcxproj
	...
	dlldata.c, simpleatlcom_i.c and simpleatlcom_p.c which are required
	to build the proxy/stub DLL.

simpleatlcomps.vcxproj.filters
